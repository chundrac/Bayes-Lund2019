...
def run_inference(K,chains):
    ...
    for c in range(chains):
        ...
        states, kernel_results = tfp.mcmc.sample_chain(
            num_results=n_results,num_burnin_steps=discard,num_steps_between_results=1,
    ...
    f = open('posterior_smooth_{}.pkl'.format(K),'wb')
    pkl.dump(posts,f)
    f.close()
...
def main():
    ...
    try:
        ...
        print('usage: python run_K_smooth.py [n clusters]')
    K = int(sys.argv[1])
    run_inference(K,4)
